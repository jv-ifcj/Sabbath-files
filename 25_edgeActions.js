...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 9141, function(sym, e) {
         sym.stop();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_q31_skip_go_button}", "click", function(sym, e) {
         sym.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q32_skip_go_button}", "click", function(sym, e) {
         sym.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q31_skip_button}", "click", function(sym, e) {
         sym.play('q31_skip_check');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q32_skip_button}", "click", function(sym, e) {
         sym.play('q32_skip_check');
         

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q31_submit_button}", "click", function(sym, e) {
         sym.play('q31_go');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q32_submit_button}", "click", function(sym, e) {
         sym.play('q32_go');
      ...
      Symbol.bindElementAction(compId, symbolName, "${_bb1}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("24.html?back", "_self");
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         if (origin == '?back') {
         sym.getComposition().getStage().play('q32_begin');
         }
         else {
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_previous}", "click", function(sym, e) {
         sym.playReverse();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_read_button}", "click", function(sym, e) {
         sym.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_done_button}", "click", function(sym, e) {
         sym.play();

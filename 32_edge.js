...
"stage": {
   ...
   content: {
         dom: [
         {
            ...
            display:'none',
            type:'image',
            rect:['151px','239px','368px','276px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"bread1.png",'0px','0px']
         },
         {
            id:'question37',
            display:'none',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid176", tween: [ "style", "${_bread1}", "display", 'block', { fromValue: 'none'}], position: 3750, duration: 0, easing: "easeOutQuad" },
            { id: "eid181", tween: [ "style", "${_bread1}", "display", 'none', { fromValue: 'block'}], position: 5250, duration: 0, easing: "easeInQuad" },
            ...
            { id: "eid171", tween: [ "transform", "${_bread1}", "scaleX", '1', { fromValue: '0.81'}], position: 3750, duration: 750, easing: "easeOutQuad" },
            { id: "eid178", tween: [ "transform", "${_bread1}", "scaleX", '0.86', { fromValue: '1'}], position: 4500, duration: 750, easing: "easeInQuad" },
            { id: "eid3", tween: [ "style", "${_buttons}", "top", '460px', { fromValue: '571px'}], position: 1500, duration: 750, easing: "easeOutQuad" },
            { id: "eid175", tween: [ "style", "${_bread1}", "opacity", '1', { fromValue: '0'}], position: 3750, duration: 750, easing: "easeOutQuad" },
            { id: "eid180", tween: [ "style", "${_bread1}", "opacity", '0', { fromValue: '1'}], position: 4500, duration: 750, easing: "easeInQuad" },
            ...
            { id: "eid173", tween: [ "transform", "${_bread1}", "scaleY", '1', { fromValue: '0.81'}], position: 3750, duration: 750, easing: "easeOutQuad" },
            { id: "eid179", tween: [ "transform", "${_bread1}", "scaleY", '0.86', { fromValue: '1'}], position: 4500, duration: 750, easing: "easeInQuad" },
            ...
            { id: "eid169", tween: [ "style", "${_bread1}", "top", '239px', { fromValue: '295px'}], position: 3750, duration: 750, easing: "easeOutQuad" },
            { id: "eid177", tween: [ "style", "${_bread1}", "top", '164px', { fromValue: '239px'}], position: 4500, duration: 750, easing: "easeInQuad" },

...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 18500, function(sym, e) {
         ...
         window.open("33.html", "_self");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q37_submit_button}", "click", function(sym, e) {
         sym.play('q33_go');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q37_skip_check_button}", "click", function(sym, e) {
         sym.play('q33_skip_check');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q37_skip_go_button}", "click", function(sym, e) {
         sym.play('q33_go');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q38_submit_button}", "click", function(sym, e) {
         sym.play('q34_go');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q38_skip_check_button}", "click", function(sym, e) {
         sym.play('q34_skip_check');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_q38_skip_go_button}", "click", function(sym, e) {
         sym.play('q34_go');

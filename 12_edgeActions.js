...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sb26}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sb27}", "click", function(sym, e) {
         sym.play(1250);
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         //sym.play('lchai_begin');
         //sym.getComposition().getStage().play();
         
         /*
         
         //alert('Query string: '+self.location.search)
         //var time=self.location.search;
         //alert('Query string: '+time);
         if (time == '?lchai'){
         sym.play('lchai_begin');
         }
         ...
         */
         ...
         if (origin == '?back') {
         sym.getComposition().getStage().play('lchai_begin');
         }
         else {
         sym.getComposition().getStage().play();
         }

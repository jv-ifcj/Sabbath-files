...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            display:'none',
            type:'text',
            rect:['216px','209','449px','0','undefined','undefined'],
            cursor:['pointer'],
            text:"Click to begin Lesson 2:<br><i>Preparing for the Sabbath</i>",
            align:"right",
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid1", tween: [ "style", "${_start_text}", "font-size", '36px', { fromValue: '36px'}], position: 3500, duration: 0 },
            ...
            { id: "eid3", tween: [ "style", "${_start_text}", "display", 'block', { fromValue: 'none'}], position: 2750, duration: 0 },
            { id: "eid7", tween: [ "style", "${_start_text}", "display", 'none', { fromValue: 'block'}], position: 4000, duration: 0 },
            ...
            { id: "eid15", tween: [ "color", "${_Stage}", "background-color", 'rgba(45,105,179,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(45,105,179,1.00)'}], position: 3500, duration: 0 },
            { id: "eid16", tween: [ "color", "${_Stage}", "background-color", 'rgba(0,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(45,105,179,1)'}], position: 6250, duration: 500 },
            { id: "eid19", tween: [ "color", "${_Stage}", "background-color", 'rgba(0,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1.00)'}], position: 6960, duration: 0 },

   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "dg120", tween: [ "transform", "${_woman_sabbath2}", "scaleY", '0.28', { fromValue: '0.23'}], position: 3250, duration: 2750 },
            { id: "dg121", tween: [ "transform", "${_woman_sabbath2}", "scaleY", '0.21', { fromValue: '0.28'}], position: 6435, duration: 1065 },
            ...
            { id: "dg122", tween: [ "transform", "${_woman_sabbath2}", "scaleX", '0.28', { fromValue: '0.23'}], position: 3250, duration: 2750 },
            { id: "dg123", tween: [ "transform", "${_woman_sabbath2}", "scaleX", '0.21', { fromValue: '0.28'}], position: 6435, duration: 1065 },
            ...
            { id: "dg119", tween: [ "style", "${_woman_sabbath2}", "top", '-274.02px', { fromValue: '-269.98px'}], position: 3250, duration: 2750 },
            ...
            { id: "dg126", tween: [ "style", "${_woman_sabbath2}", "left", '-276px', { fromValue: '-220px'}], position: 3250, duration: 2750 },
            { id: "dg127", tween: [ "style", "${_woman_sabbath2}", "left", '-177px', { fromValue: '-276px'}], position: 6435, duration: 1065 },
            ...
            { id: "dg124", tween: [ "style", "${_woman_sabbath2}", "opacity", '1', { fromValue: '0'}], position: 3250, duration: 2750 },
            { id: "dg125", tween: [ "style", "${_woman_sabbath2}", "opacity", '0', { fromValue: '1'}], position: 6435, duration: 1065 },
            { id: "dg147", tween: [ "transform", "${_question19} > form:nth-child(1)", "translateX", '-7px', { fromValue: '462px'}], position: 15500, duration: 1000 },
            { id: "dg128", tween: [ "style", "${_woman_sabbath2}", "display", 'none', { fromValue: 'block'}], position: 8000, duration: 0 },
